...
<body style="margin-top:50px;">
  ...
  <div class="carousel-inner">
    ...
    <div class="item">
       <img src="image/Twin Delux Room/Twin_img24.jpg" class="thumbnail" alt="im3">
    </div>

    <div class="item">
       <img src="image/Twin Delux Room/Twin_img25.jpg"class="thumbnail" alt="img4">
    </div>

    <div class="item">
       <img src="image/Twin Delux Room/Twin_img26.jpg"class="thumbnail" alt="img5">
    </div>
  </div>
